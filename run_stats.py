...
run_stats(2, 100, "pendulum/pendulum_config_ann.txt", "resultsAnnPendulum", AnnPendulumRE)
run_stats(1, 100, "pendulum/pendulum_config_snn.txt", "resultsSnnPendulum", SnnPendulumRE)