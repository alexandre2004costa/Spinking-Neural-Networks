...
from cartCont.cartAnn import run_experiment as AnnCartContRE
from cartCont.cartSnn import run_experiment as SnnCartContRE
...
#run_stats(30, 100, "mountain_car/mountain_config_ann.txt", "resultsAnnMountainCar", AnnMountCarRE)
#run_stats(30, 100, "mountain_car/mountain_config_snn.txt", "resultsSnnMountainCar", SnnMountCarRE)
...
run_stats(30, 250, "cartCont/cartAnn_config.txt", "resultsAnnCartCont", AnnCartContRE)
run_stats(30, 250, "cartCont/cartSnn_config.txt", "resultsSnnCartCont", SnnCartContRE)