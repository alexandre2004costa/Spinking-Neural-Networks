...
run_stats(15, 100, "pendulum/pendulum_config_ann.txt", "resultsAnnPendulum", AnnPendulumRE)
run_stats(15, 100, "pendulum/pendulum_config_snn.txt", "resultsSnnPendulum", SnnPendulumRE)